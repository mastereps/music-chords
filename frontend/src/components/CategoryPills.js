...
export function CategoryPills({ items, activeCategoryId, onSelect }) {
    return (_jsxs("div", { className: "flex gap-2 overflow-x-auto pb-1", children: [_jsx("button", { type: "button", onClick: () => onSelect(undefined), className: `rounded-full border px-4 py-2 text-sm font-medium whitespace-nowrap ${!activeCategoryId
