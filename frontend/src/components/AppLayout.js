...
export function AppLayout() {
    ...
    return (_jsxs("div", { className: "min-h-screen overflow-x-clip bg-[radial-gradient(circle_at_top,_rgba(111,144,84,0.16),_transparent_40%),linear-gradient(180deg,_#f7f8f4_0%,_#f5f3ef_100%)] text-stone-900 dark:bg-[linear-gradient(180deg,_#172014_0%,_#101711_100%)] dark:text-stone-100", children: [_jsx("header", { className: "sticky top-0 z-30 border-b border-stone-200/80 bg-stone-50/95 backdrop-blur dark:border-stone-800 dark:bg-stone-950/90", children: _jsxs("div", { className: "mx-auto flex max-w-6xl flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center sm:justify-between", children: [_jsxs(Link, { to: "/", className: "flex min-w-0 items-center justify-center gap-3 sm:justify-start", children: [_jsx("img", { src: "/images/music-charts-logo.png", alt: "Music Charts logo", className: "h-10 w-10 shrink-0 object-contain" }), _jsx("p", { className: "truncate text-[11px] uppercase tracking-[0.22em] text-brand-600 dark:text-brand-300 sm:text-xs sm:tracking-[0.3em]", children: "Music Chords" })] }), _jsxs("div", { className: "flex flex-wrap items-center justify-center gap-2 sm:justify-end", children: [_jsx(NavLink, { to: "/lineups", className: ({ isActive }) => `rounded-full border px-3 py-2 text-center text-xs font-semibold transition ${isActive
