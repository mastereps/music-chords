...
export function ActiveLineupFab({ currentSongSlug }) {
    ...
    return (_jsxs(_Fragment, { children: [isOpen ? _jsx("button", { type: "button", "aria-label": "Close lineup popup", onClick: () => setIsOpen(false), className: "fixed inset-0 z-40 bg-stone-950/45 backdrop-blur-[1px]" }) : null, _jsxs("div", { className: "fixed bottom-5 right-4 z-50 flex flex-col items-end sm:bottom-6 sm:right-6", children: [isOpen ? (_jsxs("div", { className: "mb-3 w-[calc(100vw-2rem)] max-w-sm overflow-hidden rounded-[1.8rem] border border-stone-200 bg-white/95 shadow-[0_20px_60px_rgba(18,27,12,0.28)] backdrop-blur dark:border-stone-800 dark:bg-stone-900/95", children: [_jsxs("div", { className: "border-b border-stone-200 px-4 py-4 dark:border-stone-800", children: [_jsx("p", { className: "text-xs font-semibold uppercase tracking-[0.24em] text-brand-600 dark:text-brand-300", children: "Active lineup" }), _jsx("h2", { className: "mt-2 text-lg font-semibold text-stone-900 dark:text-white", children: activeLineup.title }), _jsxs("p", { className: "mt-1 text-sm text-stone-500 dark:text-stone-400", children: ["Song ", currentSongIndex + 1, " of ", lineupSongs.length] }), _jsxs("div", { className: "mt-4 grid grid-cols-2 gap-2", children: [previousSong ? (_jsx(Link, { to: `/songs/${previousSong.slug}`, onClick: () => setIsOpen(false), className: "rounded-2xl border border-stone-300 px-3 py-3 text-center text-sm font-semibold text-stone-700 dark:border-stone-700 dark:text-stone-200", children: "Previous song" })) : (_jsx("span", { className: "rounded-2xl border border-stone-200 px-3 py-3 text-center text-sm text-stone-400 dark:border-stone-800 dark:text-stone-500", children: "At start" })), nextSong ? (_jsx(Link, { to: `/songs/${nextSong.slug}`, onClick: () => setIsOpen(false), className: "rounded-2xl bg-brand-700 px-3 py-3 text-center text-sm font-semibold text-white", children: "Next song" })) : (_jsx("span", { className: "rounded-2xl border border-stone-200 px-3 py-3 text-center text-sm text-stone-400 dark:border-stone-800 dark:text-stone-500", children: "At end" }))] })] }), _jsx("div", { className: "max-h-[min(55vh,24rem)] space-y-2 overflow-y-auto px-3 py-3", children: lineupSongs.map((song, index) => {
