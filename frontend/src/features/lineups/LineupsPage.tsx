  ...
  return (
    <div className="space-y-4 pb-8">
      ...
      {!isLoading && lineups.length === 0 ? (
        <section className="rounded-[2rem] border border-dashed border-stone-300 bg-white px-4 py-10 text-center text-sm text-stone-500  dark:border-stone-700 dark:bg-stone-900 dark:text-stone-400">
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
        {lineups.map((lineup) => (
          <Link
            ...
            className="rounded-[2rem] border border-stone-200 bg-white p-5  transition hover:border-brand-400 hover:shadow-lg dark:border-stone-800 dark:bg-stone-900"
          >
